...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'initial_pose_enabled', default_value='false',
            description='Move once to the configured calibration start pose.'),
        DeclareLaunchArgument(
            'initial_pose_config',
        ...
        # ── Optional single configured initial calibration pose ──
        Node(
